      ...
      >
        <div className="container-wrapper relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <span className="inline-block py-1 px-3 rounded-full text-sm font-medium bg-[rgba(194,122,255,0.1)] text-[var(--primary-accent)] mb-4">
                Start a Project
              </span>
            ...
            <AnimatedSection animation="slide-left" delay={0.2} ref={formRef}>
              <div className="bg-[var(--primary-bg)] rounded-2xl p-8 shadow-xl border border-[rgba(255,255,255,0.05)]">
                {formState.submitted ? (
                  ...
                  >
                    <div className="w-20 h-20 rounded-full bg-[rgba(194,122,255,0.1)] mx-auto mb-6 flex items-center justify-center">
