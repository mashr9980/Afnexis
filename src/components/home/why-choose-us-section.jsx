      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {reasons.map((reason, index) => (
            <Card
              key={index}
              className={`bg-foreground card-border rounded-xl p-6 transition-all duration-500 transform hover:translate-y-[-5px] hover:shadow-[0_0_15px_rgba(194,122,255,0.3)] delay-${
                index * 100
              }`}
            >
            ...
            return (
              <div
                ...
                className={`text-center transition-all duration-500 transform delay-${
                  index * 200
                } bg-foreground card-border rounded-xl p-8 hover:shadow-[0_0_15px_rgba(194,122,255,0.3)]`}
              >
