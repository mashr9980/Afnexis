  ...
  return (
    <main className="bg-[var(--primary-bg)]">
      ...
      <section className="py-20 md:py-32 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 z-0">
          <div className="absolute top-0 right-0 w-96 h-96 bg-[var(--primary-accent)] rounded-full filter blur-[150px] opacity-10"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[var(--secondary-accent)] rounded-full filter blur-[150px] opacity-10"></div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            <p className="text-[var(--body-text)] text-lg mb-8 max-w-2xl mx-auto">
      ...
      {/* Footer */}
      <footer className="bg-[var(--section-bg)] py-12">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="border-t border-[rgba(255,255,255,0.1)] mt-12 pt-8 text-center">
